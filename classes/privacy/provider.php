...
/**
 * Defines {@link \mod_teams\privacy\provider} class.
 *
 * @package     mod_teams
 * @category    privacy
...
/**
 * Privacy API implementation for the Teams plugin.
 *
 * @copyright  2016 Alexandru Elisei <alexandru.elisei@gmail.com>, David Mudrák <david@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
    ...
    /**
     * Describe all the places where the Teams plugin stores some personal data.
     *
    ...
    public static function get_metadata(collection $collection) : collection {
        ...
        $collection->add_database_table('mod_teams_sometable', [
        ...
        $collection->add_database_table('mod_teams_another', [
        ...
        $collection->add_user_preference('mod_teams_anotherpreference', 'privacy:metadata:preference:anotherpreference');
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if ($preferencename !== null) {
            writer::export_user_preference('mod_teams', 'preferencename', $preferencename,
                get_string('privacy:metadata:preference:preferencename', 'mod_teams'));
        }
        $anotherpreference = get_user_preferences('mod_teams_anotherpreference', null, $userid);

        if ($anotherpreference !== null) {
            writer::export_user_preference('mod_teams', 'mod_teams_anotherpreference', $anotherpreference,
                get_string('privacy:metadata:preference:anotherpreference', 'mod_teams'));
        }
    }
}
